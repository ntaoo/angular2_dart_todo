...
void main() {
  ...
  setUp(() async {
    ...
    // TODO: Currently TodoListRouter depends on Injector. Should pass all tests perhaps with angular2_testing, or maybe set up injector without it.
    UIChannel uiChannel = uiChannelFactory(appState, new TodoListRouter());
